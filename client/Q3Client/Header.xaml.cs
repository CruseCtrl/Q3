...
namespace Q3Client
{
    ...
    public partial class Header : UserControl
    {
        ...
        public bool AggressiveQueueNotifications => userConfig.AggressiveQueueNotifications;
        ...
        private void AggressiveNotificationsMenuItem_Click(object sender, RoutedEventArgs e)
        {
            userConfig.AggressiveQueueNotifications = ((MenuItem)sender).IsChecked = !userConfig.AggressiveQueueNotifications;
            DataCache.Save(userConfig);
        }
    }
}
